...
elseif ($action === 'trigger_boss_battle') {
    ...
    elseif (empty($boss_id)) { $response = ['success' => false, 'message' => 'Boss ID not provided.']; }
        ...
        if ($boss_id === 'boss_map2') {
            ...
            $boss_type = "charizard"; $boss_health = rand(300, 400); $boss_damage = rand(100, 150);
            ...
            $boss_type = "tralala"; $boss_health = rand(50000000, 100000000); $boss_damage = rand(5000000, 10000000);
            ...
            $boss_type = "pikapika"; $boss_health = rand(1000, 50000); $boss_damage = rand(5000, 10000);
